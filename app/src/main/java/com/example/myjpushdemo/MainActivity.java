package com.example.myjpushdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init = (Button) findViewById(R.id.btn1);
        stopPush = (Button) findViewById(R.id.btn2);
        resumePush = (Button) findViewById(R.id.btn3);
        registrationId = (Button) findViewById(R.id.btn4);
    }
